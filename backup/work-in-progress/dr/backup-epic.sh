...
/usr/bin/umount /dev/drinstvg/epiclv /mnt/backup-nfs/RHEL-OS-DR/epic/
/usr/bin/umount /dev/drinstvg/drlv /mnt/backup-nfs/RHEL-OS-DR/prd/
/usr/bin/umount /dev/drinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-DR/epictmp/
...
/usr/bin/mount /dev/drinstvg/epiclv /mnt/backup-nfs/RHEL-OS-DR/epic/
/usr/bin/mount /dev/drinstvg/drlv /mnt/backup-nfs/RHEL-OS-DR/prd/
/usr/bin/mount /dev/drinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-DR/epictmp/
...
chmod -R 777 /mnt/backup-nfs/RHEL-OS-DR/epic/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-DR/prd/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-DR/epictmp/
