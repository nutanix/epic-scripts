...
ssh -q nutanix@1.2.3.4-cvmip-here exit
...
/root/scripts/backup/dr/backup-prd01.sh
sleep 60

echo "Start backup-epic.sh"
#This script only does freeze NOT thaw
/root/scripts/backup/dr/backup-epic.sh
sleep 60

echo "Start backup-jrn.sh"
#This script only does freeze NOT thaw
/root/scripts/backup/dr/backup-jrn.sh
sleep 60
...
/root/scripts/backup/dr/backup-epicfiles.sh
sleep 60
...
#/root/scripts/backup/dr/backup-veeam-dr.sh
