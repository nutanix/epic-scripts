...
TARGET_ODB_ENV[0]="rpt"
TARGET_ODB_FILEPATH[0]="epic"
...
TARGET_NTNX_VG[0]="rpt-odb-inst"

# Linux LVM Volume Group name
LVM_VG[0]="rptinstvg"

# Mount point for volume group
MP[0]="/mnt/backup-nfs/RHEL-OS-RPT/${TARGET_ODB_FILEPATH[0]}"
...
#Manually Added Unmounts
/usr/bin/umount /dev/rptinstvg/epiclv /mnt/backup-nfs/RHEL-OS-RPT/epic/
/usr/bin/umount /dev/rptinstvg/rptlv /mnt/backup-nfs/RHEL-OS-RPT/rpt/
/usr/bin/umount /dev/rptinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-RPT/epictmp/

# Old Code - Stayed here as reference
...
###############################################################################
## Backup - Stage - Freeze target ODB # N/A
###############################################################################

# This will implemented
...
#Manually Added Mounts
/usr/bin/mount /dev/rptinstvg/epiclv /mnt/backup-nfs/RHEL-OS-RPT/epic/
/usr/bin/mount /dev/rptinstvg/rptlv /mnt/backup-nfs/RHEL-OS-RPT/rpt/
/usr/bin/mount /dev/rptinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-RPT/epictmp/

# Old Code - Stayed as reference
# Get device name
...
chmod -R 777 /mnt/backup-nfs/RHEL-OS-RPT/epic/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-RPT/rpt/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-RPT/epictmp/
