...
TARGET_NTNX_VG[0]="prd-odb-inst"

# Linux LVM Volume Group name
LVM_VG[0]="prdinstvg"

# Mount point for volume group
MP[0]="/mnt/backup-nfs/RHEL-OS-PRD/${TARGET_ODB_FILEPATH[0]}"
...
/usr/bin/umount /dev/prdinstvg/epiclv /mnt/backup-nfs/RHEL-OS-PRD/epic/
/usr/bin/umount /dev/prdinstvg/prdlv /mnt/backup-nfs/RHEL-OS-PRD/prd/
/usr/bin/umount /dev/prdinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-PRD/epictmp/
...
/usr/bin/mount /dev/prdinstvg/epiclv /mnt/backup-nfs/RHEL-OS-PRD/epic/
/usr/bin/mount /dev/prdinstvg/prdlv /mnt/backup-nfs/RHEL-OS-PRD/prd/
/usr/bin/mount /dev/prdinstvg/epictmplv /mnt/backup-nfs/RHEL-OS-PRD/epictmp/
...
chmod -R 777 /mnt/backup-nfs/RHEL-OS-PRD/epic/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-PRD/prd/
chmod -R 777 /mnt/backup-nfs/RHEL-OS-PRD/epictmp/
